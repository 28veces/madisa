...
import { createBusiness } from "@/actions/super-admin";
...
export default function NuevoNegocioPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (result.error) {
      ...
      router.push("/admin/super/negocios");
    }
    setLoading(false);
  }
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Crea un nuevo negocio en el sistema</p>
      </div>
